...
- Create a shared login for the survey system
:::
...
| Introduction to formr                            |    30    |                                           |
| Group work 2: Implement the survey               |    45    |                                           |
| Causality                                        |    60    | [Slides](/slides/Causality/Causality.qmd) |
| Homework: Create the video (or rather in class?) |          |                                           |

: {.striped}


## Group work: Preparing the study

Group tasks:

- Prepare our OSF project (steps 5-8 of the [CREP Guide](https://docs.google.com/document/d/13iShvF76RDlLSmWMzhr5jeLAetzRQGHobCQSovkO1mo/edit?tab=t.0))
