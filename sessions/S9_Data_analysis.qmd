...
As homework, prepare the general structure of a scientific paper. 
Add all section headings; "Methods", "Results", "Discussion" should be Level 1 (with `#`).

Next, write the Methods section (see details in next [Session Overview](S10-How_to_Hausarbeit.qmd)).
...
Look at some of the APA's [sample papers](https://apastyle.apa.org/style-grammar-guidelines/paper-format/sample-papers), and read the respective sections in a couple of papers from our literature list.
