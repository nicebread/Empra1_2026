...
| Threats to credible research lecture, part 1     |   100    | [Slides](../slides/Replicability_Crisis/OS-M1-S1-Replicability-slides.qmd)                            |
| Break                                            |    15    |                                                                                                       |
...
- Create an [ORCID ID](https://orcid.org). Use your real name. You can use "Ludwig-Maximilians-Universität München" as affiliation.
- Create an [OSF](https://osf.io) account. Use your real name; link your ORCID ID.
- Create a [GitHub](https://github.com) account. You can use your real name or any pseudonym.
