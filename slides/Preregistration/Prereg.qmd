...
author:
  - name: Sara Lil Middleton
    ...
    email: Sara.Middleton@psy.lmu.de
...
| <span class="fragment" data-fragment-index="4">**Confirmation bias**</span> | <span class="fragment" data-fragment-index="5">Tendency to seek out, interpret, favor and recall information in a way that supports one’s prior expectations</span> | <span class="fragment" data-fragment-index="6">Write down your decision rules and analysis plan before you see the data</span> |
...
::: footer
adapted from Nosek & Lindsay (2018), PRP-QUANT template, and [RESQUE](https://www.resque.info/).
:::
