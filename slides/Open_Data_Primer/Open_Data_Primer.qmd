...
::: {style="background:#add8e6; border:2px solid #000; padding:20px; width:300px; text-align:center; font-size:32px;"}
Open Data, public interest, entitlement to publicly funded data
:::
::: {style="font-size:40px;"}
↔
:::
::: {style="background:#90ee90; border:2px solid #000; padding:20px; width:300px; text-align:center; font-size:32px;"}
...
::: {style="display:flex; justify-content:center; align-items:center; gap:30px; margin-top:20px;"}
::: {style="background:#add8e6; border:2px solid #000; padding:20px; width:300px; text-align:center; font-size:24px;"}
Open Data, public interest, entitlement to publicly funded data
:::
::: {style="font-size:40px;"}
↔
:::
::: {style="background:#90ee90; border:2px solid #000; padding:20px; width:300px; text-align:center; font-size:24px;"}
Privacy rights of research subjects
:::
:::
