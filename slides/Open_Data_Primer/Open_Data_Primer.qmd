...
C["Right of first usage,\nincentives to collect data\nin the first place"] <--> D["Optimal and efficient gain of\nknowledge by data reuse"]

style C fill:#add8e6,stroke:#000,font-size:24px
style D fill:#90ee90,stroke:#000,font-size:24px
``` 
</div>
