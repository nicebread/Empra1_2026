...
<style>
.left-table table { margin-left: 0 !important; }
</style>

::: {.left-table style="margin-top: 3em;"}
| | Reality:<br>Effect present | Reality:<br>No effect present | 
|---|:---:|:---:|
| **Test indicates:<br>Effect present** | True Positive | False Positive |
| **Test indicates:<br>No effect present** | False Negative | True Negative |
...
**A priori power analysis:** We assume that the effect exists in reality. <br>
&rarr; *We focus on the left column ("Reality: Effect present")*
:::

::: {.left-table}
| | Reality:<br>Effect present | Reality:<br>No effect present | 
|---|:---:|:---:|
| **Test indicates:<br>p < .05** | <span style="color:blue; font-size:1.2em">**Power = 1-β**</span><br>True Positive | <span style="color:blue; font-size:1.2em">**α = 5%**</span><br>False Positive |
| **Test indicates:<br>p > .05** | <span style="color:blue; font-size:1.2em">**β = 20%**</span><br>False Negative | <br>True Negative |
: {tbl-colwidths="[34, 33, 33]"}
:::

::: {.callout-note icon=false}
**Power:** The probability to detect an effect if an effect is present.
:::
...
```{mermaid}
flowchart LR
    L["<b>Significance Level</b><br>0.05? 0.005 (Benjamin et al., 2018)?<br>justify your alpha (Lakens et al., 2018)?"]
    D["<b>Desired Power</b><br>usually 80%, 90% recommended for<br>critical studies (Bondavera, 2013)"]
    E["<b>Effect Size</b><br>(see Part II of the workshop)"]
    S["<b>Sample Size</b>"]
...
::: {.footer}
Wagenmakers et al. (2014). A power fallacy. *Behavior Research Methods, 47*, 913–917. doi:10.3758/s13428-014-0517-4
::: 
...
power" is meaningless (it‘s just a transformation of the p-value)
...
Given that *p* < .05: <br> What is the probability that a real effect exists in the population ➙ $p(H_1 | D)$?
...
![](img/effectsize.png){fig-align="left" height="250"}
...
::: {.footer}
McGraw & Wong (1992). A common language effect size statistic. [https://doi.org/10.1037/0033-2909.111.2.361](https://doi.org/10.1037/0033-2909.111.2.361)
::: 
...
### Richard, Bond, & Stokes-Zoota (2003), correlation metric
...
### Bosco et al. (2015), correlation metric
...
::: {.footer}
Bosco et al. (2015). Correlational effect size benchmarks. [http://doi.org/10.1037/a0038047](http://doi.org/10.1037/a0038047)
:::

## Typical reported effect sizes III
### Hill et al. (2008), Hedge's *g*
...
::: {.footer}
Hill et al. (2008). Empirical Benchmarks for Interpreting Effect Sizes in Research. doi:10.1111/j.1750-8606.2008.00061.x
:::

## Typical reported effect sizes IV
### Funder & Ozer (2019), correlation metric
...
### Aguinis, Beaty, Boik, & Pierce (2005), $f^2$
...
::: {.footer}
Aguinis et al. (2005). Effect size and power in assessing moderating effects of categorical variables using multiple regression: a 30-year review. Journal of Applied Psychology, 90(1), 94.
:::
...
<!-- These two slides are in the separate "Power-Analysis Reporting" slides
